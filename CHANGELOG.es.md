...
- Punto de estado animado en la pestaña activa: un punto con pulso suave junto a la pestaña actual muestra la salud de esa fuente — verde intenso cuando todo funciona, ámbar en [Spotify] en modo Remoto sin dispositivo, rojo en [YouTube] con la sesión de cookies expirada y gris sin conectar o configurar
